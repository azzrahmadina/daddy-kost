        ...
        <div class="col-lg-12 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-4">
              <h5 class="card-title fw-semibold mb-4">Tabel Pengaduan</h5>
                @if (session('success'))
              ...
              <div class="d-flex justify-content-end me-4">
                <button id="btnadd" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#mdladd">+ Tambah pengaduan</button>
              </div>
              <div class="table-responsive mt-2">
                <div class="col-md-4 mt-2">
                    <form action="/pengaduan/search" method="GET" class="d-inline">
                        <div class="input-group mb-1">
                            <input type="text" name="search" placeholder="Search Pengaduan" class="form-control" required>
                ...
                <table class="table table-stripped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="border-bottom-0">
                        <button data-id="{{ $peng->id }}" id="btnedit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mdledit">
                            Edit
                        </button>
                        <form method="POST" action="{{ URL::to('admin/pengaduan/'. $peng->id) }} " class="d-inline">
    ...
    <div class="modal-dialog modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ URL::to('admin/pengaduan/') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-1">
            ...
            <select class="form-control" id="status" name="status">
              ...
              @foreach(\App\Models\Pengaduan::getStatusOptions() as $status)
...
<script type="text/javascript">
    ...
    $(document).on("click", "#btnedit", function (e) {
        ...
        $.ajax({
            type: 'GET',
            url: '/admin/pengaduan/' + id + '/edit', // Endpoint untuk mendapatkan data pengaduan
            dataType: 'JSON',
            success: function (response) {
                ...
                $("#mdledit form").attr("action", "/admin/pengaduan/" + id);
            },
