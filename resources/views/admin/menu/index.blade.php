        ...
        <div class="col-lg-12 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-4">
              <h5 class="card-title fw-semibold mb-4">Tabel Menu Makanan</h5>
                @if (session('success'))
                ...
                <div class="d-flex justify-content-end me-4">
                  <button id="btnadd" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#mdladd">+ Tambah menu</button>
                </div>
                <div class="table-responsive mt-2">
                <div class="col-md-4 mt-2">
                    <form action="/menu/search" method="GET" class="d-inline">
                        <div class="input-group mb-1">
                            <input type="text" name="search" placeholder="Search Menu" class="form-control" required>
                ...
                <table class="table table-stripped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="border-bottom-0">
                        <button data-id="{{ $me->id }}" id="btnedit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mdledit">
                            Edit
                        </button>
                        <form method="POST" action="{{ URL::to('admin/menu/'. $me->id) }} " class="d-inline">
    ...
    $(document).on("click", "#btnedit", function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#mdledit form").attr("action", "/admin/menu/" + id);
            },
