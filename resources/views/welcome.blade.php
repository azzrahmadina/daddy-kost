          ...
          <div class="header-bottom offcanvas offcanvas-end " id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              ...
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                ...
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="{{URL::to('login')}}">Favorite</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="{{URL::to('login')}}">Notification</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="{{URL::to('login')}}">FAQ</a>
                </li>
      ...
      <div class="row align-items-start mt-3 mt-lg-5">
        <div class="col-lg-6">
          <div class="p-5">
            ...
            <a href="{{URL::to('sejarah')}}" class="btn btn-arrow btn-primary mt-3">
          ...
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                ...
                <a href="index.html">
                  <a href="{{URL::to('login')}}" class="link" id="openFormLink">Sewa Kost</a>
                </a>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                ...
                <a href="index.html">
                  <a href="#" class="link" id="openFormLink">Sewa Kost</a>
                </a>
              </div>
            </div>
            <div class="room-content text-center mt-3">
            ...
            <form id="rentalForm">
              ...
              <div class="form-group">
                ...
                <select id="duration" name="duration" required>
                  ...
                  <option value="9">Pria</option>
                  <option value="8">Wanita</option>
                  <option value="7">Lainnya</option>
                </select>
              </div>
              <div class="form-group">
                <label for="duration">Kategori Kamar</label>
                <select id="duration" name="duration" required>
                  <option value="">Pilih Kategori </option>
                  <option value="12">Woman Alpha 1</option>
                  <option value="12">Woman Sigma 2</option>
                  <option value="12">Woman Enigma 3</option>
                  <option value="13">Man Alpha 1</option>
                  <option value="13">Man Sigma 2</option>
                  <option value="13">Man Enigma 3</option>
                  <option value="14">Couple Alpha 1</option>
                  <option value="14">Family Sigma 2</option>
                  <option value="14">Big Family 3</option>
                </select>
              </div>
              <div class="form-group">
