...
<body>
            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              ...
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                <li class="nav-item px-3">
                  <a class="nav-link active p-0" aria-current="page" href="{{URL::to('welcome')}}">Home</a>
                </li>
                <li class="nav-item px-3">
  ...
  <section id="about-us" class="padding-large">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <h3 class="display-3 fw-normal text-center">Daddy kost: take your hiraeth in here</h3>
      <div class="row align-items-start mt-3 mt-lg-5">
        <div class="col-lg-6">
          <div class="p-5">
            <p>Daddy Kost offers a welcoming and comfortable environment, designed to make you feel at home. 
              Located in a peaceful neighborhood, it provides a sense of calm while still being close to key areas 
              for convenience. Whether you're a student or a professional, Daddy Kost creates a community where you can 
              relax, focus, and enjoy your stay in a friendly and supportive atmosphere.</p>
            <a href="story.html" class="btn btn-arrow btn-primary mt-3">
              <span>Read About Us <svg width="18" height="18">
                  <use xlink:href="#arrow-right"></use>
                </svg></span>
            </a>
          </div>
          <img src="{{asset('assets/images/download (12).jpg')}}" alt="img" class="img-fluid rounded-4 mt-4" >
        </div>
        <div class="col-lg-6 mt-5 mt-lg-0">
          <img src="{{asset('assets/images/laundry.jpg')}}" alt="img" class="img-fluid rounded-4" style="height: 400px; width: 750px;">
          <img src="{{asset('assets/images/open cabinet kitchen.jpg')}}" alt="img" class="img-fluid rounded-4 mt-4" style="height: 350px; width: 800px;">
    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        <div class="col-md-3 text-center mb-4 mb-lg-0">
          <h3 class="display-1 fw-normal text-primary position-relative">5K <span
              class="position-absolute top-50 end-50 translate-middle z-n1 ps-lg-4 pt-lg-4"><img
                src="{{asset('assets/images/pattern1.png')}}" alt="pattern" class="img-fluid"></span></h3>
          <p class="text-capitalize">Happy Customer</p>
        </div>
        <div class="col-md-3 text-center mb-4 mb-lg-0">
          <h3 class="display-1 fw-normal text-primary position-relative">150 <span
              class="position-absolute top-50 translate-middle z-n1"><img src="{{asset('assets/images/pattern1.png')}}" alt="pattern"
        ...
        <div class="col-md-3 text-center mb-4 mb-lg-0">
          <h3 class="display-1 fw-normal text-primary position-relative">25 <span
              class="position-absolute top-100 pb-5 translate-middle z-n1"><img src="{{asset('assets/images/pattern1.png')}}" alt="pattern"
                class="img-fluid"></span></h3>
          <p class="text-capitalize">remaining rooms</p>
        </div>
        <div class="col-md-3 text-center mb-4 mb-lg-0">
  ...
  <section id="room" class="padding-medium">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <div class="d-flex flex-wrap align-items-center justify-content-between">
        ...
        <a href="favorite.html" class="btn btn-arrow btn-primary mt-3">
          <span>Favorite room<svg width="18" height="18">
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/kamar anak.jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Woman Alpha 1</h4>
                <p class="product-paragraph text-white">Designed for those who seek a balanced living experience, 
                  the Alpha room offers a spacious and comfortable atmosphere, perfect for both work and relaxation. 
                  It’s the ideal choice for individuals who value both privacy and convenience.</p>
                <table>
                  <tbody>
                    <tr class="text-white">
                      <td class="pe-2">Price:</td>
                      <td class="price">800k /Permonth</td>
                    </tr>
                    <tr class="text-white">
                ...
                <a href="index.html">
                  <a href="#"  class="openFormLink link">Sewa Kost</a>
                </a>
              </div>
            </div>
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Woman Alpha 1</a></h4>
              <p><span class="text-primary fs-4">800k</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/korea.jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Woman Sigma 2</h4>
                <p class="product-paragraph text-white">For those who appreciate a more minimalistic and efficient space, 
                  the Sigma room offers a sleek, modern design with everything you need to make the most of your time. 
                  It’s perfect for individuals who prefer a more streamlined and practical living environment.</p>
                <table>
                  <tbody>
                    <tr class="text-white">
                      <td class="pe-2">Price:</td>
                      <td class="price">1,5m /Permonth</td>
                    </tr>
                    <tr class="text-white">
                      <td class="pe-2">Size:</td>
                      <td>10 ft</td>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Woman Sigma 2</a></h4>
              <p><span class="text-primary fs-4">1,5M</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/download (9).jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Woman Enigma 3</h4>
                <p class="product-paragraph text-white">The Enigma room is for those who crave a more eclectic and inspiring environment. 
                  With its creative design and unique ambiance, 
                  it’s the ideal choice for individuals who want a space that reflects their personality and encourages creativity.</p>
                <table>
                  <tbody>
                    <tr class="text-white">
                      <td class="pe-2">Price:</td>
                      <td class="price">2,5m /Permonth</td>
                    </tr>
                    <tr class="text-white">
                      <td class="pe-2">Size:</td>
                      <td>10 ft</td>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Woman Enigma 3</a></h4>
              <p><span class="text-primary fs-4">2,5M</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/kamar2.jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Man Alpha 1</h4>
                <p class="product-paragraph text-white">Designed for those who seek a balanced living experience, 
                  the Alpha room offers a spacious and comfortable atmosphere, perfect for both work and relaxation. 
                  It’s the ideal choice for individuals who value both privacy and convenience.</p>
                <table>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Man Alpha 1</a></h4>
              <p><span class="text-primary fs-4">800k</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/kamar laki.jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Man Sigma 2</h4>
                <p class="product-paragraph text-white">For those who appreciate a more minimalistic and efficient space, 
                  the Sigma room offers a sleek, modern design with everything you need to make the most of your time. 
                  It’s perfect for individuals who prefer a more streamlined and practical living environment.</p>
                <table>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Man Sigma 2</a></h4>
              <p><span class="text-primary fs-4">1,5M</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/download (9).jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Man Enigma 3</h4>
                <p class="product-paragraph text-white">The Enigma room is for those who crave a more eclectic and inspiring environment. 
                  With its creative design and unique ambiance, 
                  it’s the ideal choice for individuals who want a space that reflects their personality and encourages creativity.</p>
                <table>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Man Enigma 3</a></h4>
              <p><span class="text-primary fs-4">2,5M</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/download (10).jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Couple Alpha 1</h4>
                <p class="product-paragraph text-white">Designed for those who seek a balanced living experience, 
                  the Alpha room offers a spacious and comfortable atmosphere, perfect for both work and relaxation. 
                  It’s the ideal choice for individuals who value both privacy and convenience.</p>
                <table>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Couple Alpha 1</a></h4>
              <p><span class="text-primary fs-4">1,5M</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/download (11).jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Family Sigma 2</h4>
                <p class="product-paragraph text-white">For those who appreciate a more minimalistic and efficient space, 
                  the Sigma room offers a sleek, modern design with everything you need to make the most of your time. 
                  It’s perfect for individuals who prefer a more streamlined and practical living environment.</p>
                <table>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Family Sigma 2</a></h4>
              <p><span class="text-primary fs-4">3M</span>/Mounth</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              <img src="{{asset('assets/images/Double Bedroom.jpg')}}" alt="img" class="post-image img-fluid rounded-4" style=" width: 600px; height: 600px;">
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Big Family Enigma 3</h4>
                <p class="product-paragraph text-white">The Enigma room is for those who crave a more eclectic and inspiring environment. 
                  With its creative design and unique ambiance, 
                  it’s the ideal choice for individuals who want a space that reflects their personality and encourages creativity.</p>
                <table>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="index.html">Big Family Enigma 3</a></h4>
              <p><span class="text-primary fs-4">5M</span>/Mounth</p>
            </div>
          </div>
        </div>
        <div class="swiper-pagination room-pagination position-relative mt-5"></div>
        {{-- Modal Sewa --}}
        <div class="modal" id="rentalFormModal">
          <div class="modal-content">
            <div class="modal-header mb-3 p-2">
              <h2>Form Sewa Kost</h2>
              <span class="close" id="closeFormButton">&times;</span>
            </div>
            <div class="modal-body px-3">
              <form action="{{ URL::to('welcomeUser/') }}" method="POST" id="rentalForm">
                @csrf
                <div id="step-1" class="step">
                  <h4>Data Diri</h4>
                    ...
                    <button type="button" class="btn universal-btn btn-secondary nextStep">Next</button>
                </div>
                <div id="step-2" class="step" style="display: none;">
                  <h4>Data Kamar</h4>
                    ...
                    <button type="button" class="btn universal-btn btn-secondary prevStep" >Previous</button>
                    <button type="submit" class="btn  universal-btn btn-dark submitForm" >Submit</button>              </div>
                </div>
              </form>
          </div>
        </div>
      ...
      <div class="row mt-5">
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            <div class="position-relative">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"  width="100" height="100"><path fill="#DE8F5F" d="M631.2 96.5L436.5 0C416.4 27.8 371.9 47.2 320 47.2S223.6 27.8 203.5 0L8.8 96.5c-7.9 4-11.1 13.6-7.2 21.5l57.2 114.5c4 7.9 13.6 11.1 21.5 7.2l56.6-27.7c10.6-5.2 23 2.5 23 14.4V480c0 17.7 14.3 32 32 32h256c17.7 0 32-14.3 32-32V226.3c0-11.8 12.4-19.6 23-14.4l56.6 27.7c7.9 4 17.5 .8 21.5-7.2L638.3 118c4-7.9 .8-17.6-7.1-21.5z"/></svg>
              <img src="{{asset('assets/images/pattern2.png')}}" alt="img"
                class="position-absolute top-100 start-50 translate-middle z-n1 pe-5">
            </div>
            <h4 class="display-6 fw-normal my-3">Laundry Area</h4>
            <p>Understanding the importance of convenience, we have an on-site laundry 
              area with washing machines and dryers. You can easily manage your laundry 
              without having to leave the property.</p>
          </div>
        </div>
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            <div class="position-relative">
              <svg class="color" width="100" height="100">
                <use xlink:href="#chef-hat"></use>
              </svg>
              <img src="{{asset('assets/images/pattern2.png')}}" alt="img"
                class="position-absolute top-100 start-50 translate-middle z-n1 pe-5">
            </div>
            <h4 class="display-6 fw-normal my-3">Shared Kitchen</h4>
            <p>Our shared kitchen is fully equipped with modern appliances, allowing you to cook, store food, and enjoy homemade meals with ease. 
              Whether you're preparing a quick snack or cooking a full meal, the kitchen is a space for creativity and relaxation.</p>
          </div>
        </div>
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            <div class="position-relative">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 416 512" class="color" width="100" height="100"><path fill="#DE8F5F" d="M207.9 15.2c.8 4.7 16.1 94.5 16.1 128.8 0 52.3-27.8 89.6-68.9 104.6L168 486.7c.7 13.7-10.2 25.3-24 25.3H80c-13.7 0-24.7-11.5-24-25.3l12.9-238.1C27.7 233.6 0 196.2 0 144 0 109.6 15.3 19.9 16.1 15.2 19.3-5.1 61.4-5.4 64 16.3v141.2c1.3 3.4 15.1 3.2 16 0 1.4-25.3 7.9-139.2 8-141.8 3.3-20.8 44.7-20.8 47.9 0 .2 2.7 6.6 116.5 8 141.8 .9 3.2 14.8 3.4 16 0V16.3c2.6-21.6 44.8-21.4 48-1.1zm119.2 285.7l-15 185.1c-1.2 14 9.9 26 23.9 26h56c13.3 0 24-10.7 24-24V24c0-13.2-10.7-24-24-24-82.5 0-221.4 178.5-64.9 300.9z"/></svg>
              <img src="{{asset('assets/images/pattern2.png')}}" alt="img"
                class="position-absolute top-100 start-50 translate-middle z-n1 pe-5">
            </div>
            <h4 class="display-6 fw-normal my-3">Catering</h4>
            <p>For added convenience, we offer a catering service with healthy and delicious meal options. 
              Residents can order daily meals prepared with high-quality ingredients, making it easy to enjoy practical, 
              nutritious meals without the hassle of cooking.</p>
          </div>
        </div>
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            <div class="position-relative">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"  width="100" height="100"><path fill="#DE8F5F" d="M352.6 128c-28.1 0-54.1 4.5-77.1 12.9l12.4-123.1C289 7.3 279.8-1.2 269.3 .1 189.6 10.1 128 77.6 128 159.4c0 28.1 4.5 54.1 12.9 77.1L17.8 224.1C7.3 223-1.2 232.2 .1 242.7c10 79.7 77.5 141.3 159.3 141.3 28.1 0 54.1-4.5 77.1-12.9l-12.4 123.1c-1.1 10.4 8.1 18.9 18.6 17.6 79.7-10 141.3-77.5 141.3-159.3 0-28.1-4.5-54.1-12.9-77.1l123.1 12.4c10.4 1.1 18.9-8.1 17.6-18.6-10-79.7-77.5-141.3-159.3-141.3zM256 288a32 32 0 1 1 32-32 32 32 0 0 1 -32 32z"/></svg>
              <img src="{{asset('assets/images/pattern2.png')}}" alt="img"
                class="position-absolute top-100 start-50 translate-middle z-n1 pe-5">
            </div>
              <h4 class="display-6 fw-normal my-3">Air Conditioning</h4>
              <p>To ensure your comfort, all common areas are equipped with air conditioning. 
                The rooms are designed with temperature control in mind, so you can stay cool 
                during the warmer months or warm during cooler weather.
              </p>
          </div>
        </div>
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            <div class="position-relative">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"  width="100" height="100"><path fill="#DE8F5F" d="M622.3 271.1l-115.2-45c-4.1-1.6-12.6-3.7-22.2 0l-115.2 45c-10.7 4.2-17.7 14-17.7 24.9 0 111.6 68.7 188.8 132.9 213.9 9.6 3.7 18 1.6 22.2 0C558.4 489.9 640 420.5 640 296c0-10.9-7-20.7-17.7-24.9zM496 462.4V273.3l95.5 37.3c-5.6 87.1-60.9 135.4-95.5 151.8zM224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm96 40c0-2.5 .8-4.8 1.1-7.2-2.5-.1-4.9-.8-7.5-.8h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c6.8 0 13.3-1.5 19.2-4-54-42.9-99.2-116.7-99.2-212z"/></svg>
              <img src="{{asset('assets/images/pattern2.png')}}" alt="img"
                class="position-absolute top-100 start-50 translate-middle z-n1 pe-5">
            </div>
            <h4 class="display-6 fw-normal my-3">24/7 Security</h4>
            <p>Your safety is our top priority. Daddy Kost is equipped with 24/7 security 
              surveillance and on-site personnel who monitor the premises at all times. Our secure entry systems and well-lit outdoor 
              areas ensure you feel safe both inside your room and in the shared spaces.</p>
        ...
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            ...
            <h4 class="display-6 fw-normal my-3">High-Speed Wi-Fi</h4>
            <p>Stay connected with fast and reliable internet access available 
              throughout the building. Whether you're working from home, studying, or just relaxing, 
              you can always count on a stable connection.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="gallery" data-aos="fade-up">
    ...
    <p class="text-center col-lg-4 offset-lg-4 mb-5">Our kost gallery is a cozy shared space with modern decor,
       natural lighting, and vibrant artwork. Perfect for relaxing, socializing, or unwinding after a busy day.</p>
    <div class="container position-relative mb-5">
      <div class="row">
        <div class="swiper gallery-swiper offset-1 col-6">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="{{asset('assets/images/download (7).jpg')}}" alt="img" class="img-fluid rounded-4" style="width: 1000px; height: 600px;">
            </div>
            <div class="swiper-slide">
              <img src="{{asset('assets/images/45d42392-a253-48a3-ba79-20def683b211.jpg')}}" alt="img" class="img-fluid rounded-4" style="width: 1000px; height: 600px;">
            </div>
            <div class="swiper-slide">
              <img src="{{asset('assets/images/open cabinet kitchen.jpg')}}" alt="img" class="img-fluid rounded-4" style="width: 1000px; height: 600px;">
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="footer">
    <hr class="text-black">
    <div class="container-fluid padding-side mt-5" data-aos="fade-up">
      <footer class="row">
        <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
          <img src="{{asset('assets/images/ok.jpg')}}" alt="logo-footer" class="img-fluid">
          <p class="mt-3">Welcome to Daddy Kost! Enjoy the cozy atmosphere and facilities we've prepared to meet your needs. 
            If you need any assistance, don't hesitate to reach out to us. Have a great stay and feel at home!"</p>
        </div>
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
          <h4 class="display-6 fw-normal">Kebijakan</h4>
          <ul class="nav flex-column">
            <li class="nav-item"><a href="{{URL::to('kebijakan')}}" class="p-0 "> Kebijakan & Privasi </a></li>
            <li class="nav-item"><a href="{{URL::to('syarat')}}" class="p-0 "> Syarat & Ketentuan </a></li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
          <h4 class="display-6 fw-normal">Hubungi Kami</h4>
          <ul class="nav flex-column">
            <li class="nav-item"><a href="#" class="p-0 "> Email </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> WhatsApp </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Instragram </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Tiktok </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Facebook </a></li>
          </ul>
  ...
  <script>
   $(document).ready(function () {
    ...
    const $rentalFormModal = $('#rentalFormModal');
    let currentStep = 1;

    // Membuka modal ketika link "Sewa Kost" diklik
    $('.openFormLink').on('click', function (e) {
        e.preventDefault();
        $rentalFormModal.css('display', 'flex');
    });

    // Menutup modal ketika tombol close diklik
    $('#closeFormButton').on('click', function () {
        $rentalFormModal.css('display', 'none');
    });

    // Menutup modal ketika klik di luar modal
    $(window).on('click', function (e) {
        if ($(e.target).is($rentalFormModal)) {
            $rentalFormModal.css('display', 'none');
        }
    });

    // Fungsi untuk navigasi langkah
    const nextStep = (direction) => {
        $(`#step-${currentStep}`).hide(); // Sembunyikan langkah saat ini
        currentStep += direction; // Tambahkan atau kurangi langkah
        $(`#step-${currentStep}`).show(); // Tampilkan langkah berikutnya
    };

    // Event untuk tombol Next
    $('.nextStep').on('click', function () {
        nextStep(1); // Navigasi ke langkah berikutnya
    });

    // Event untuk tombol Prev
    $('.prevStep').on('click', function () {
        nextStep(-1); // Navigasi ke langkah sebelumnya
    });

    // Submit Form
    $('.submitForm').on('click', function () {
        // Reset langkah ke awal
        currentStep = 1;
        $('#step-1').show();
        $('#step-2').hide();
    ...
    e.preventDefault(); // Mencegah submit default
      ...
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $(this).closest('form').submit(); // Lanjutkan submit form terkait
          }
      });
    });
  ...
  {{-- <script>
    const openFormLinks = document.querySelectorAll('.openFormLink');
    const closeFormButton = document.getElementById('closeFormButton');
    const rentalFormModal = document.getElementById('rentalFormModal');
    ...
    // Modal Form Data Diri dan Data Kamar
    let currentStep = 1;
